...
public class OutOfProcessSubmitService implements ISubmitService, ServletContextListener {
	...
	// FIXME: make configuration parameters configurable
	public static final int PORT = 47374;

	private ServerTask serverTask;
	private Thread serverThread;
	
	@Override
	public List<TestResult> submit(Problem problem, String programText) throws SubmissionException {
		if (serverTask == null) {
			throw new IllegalStateException();
		}
		Submission submission = new Submission(problem, programText);
