...
/**
 * Transaction to search the repository for exercises.
 */
public class SearchRepositoryExercises
		extends AbstractDatabaseRunnableNoAuthException<List<RepoProblemSearchResult>> {
	private final RepoProblemSearchCriteria searchCriteria;
	 ...
	 */
	public SearchRepositoryExercises(
			RepoProblemSearchCriteria searchCriteria) {
